<script lang="ts">
    ...
    import {
     ...
     const toggle1P = () => {
         ...
         && newData.homicide_by_firearm.length!=0 
         && newData.handgun.length!=0 
         && newData.rifle.length!=0 
         && newData.shotgun.length!=0
         && newData.type_not_stated.length!=0){
 ...
 //Busqueda especifica
     ...
     const buscar = () => {
         ...
         if(databusqueda.homicide_by_firearm.replace(" ","").length!=0){
             flags= flags+"&homicide_by_firearm="+databusqueda.homicide_by_firearm;
         }
         if(databusqueda.handgun.replace(" ","").length!=0){
             flags= flags+"&handgun="+databusqueda.handgun;
         }
         if(databusqueda.rifle.replace(" ","").length!=0){
             flags= flags+"&rifle="+databusqueda.rifle;
         }
         if(databusqueda.shotgun.replace(" ","").length!=0){
             flags= flags+"&shotgun="+databusqueda.shotgun;
         }
         if(databusqueda.type_not_stated.replace(" ","").length!=0){
             flags= flags+"&type_not_stated="+databusqueda.type_not_stated;
         }
 ...
 <main>
                         ...
                         <Table >
                             ...
                             <tbody>
                                   <tr>
                                         ...
                                         <td>Homicidios por armas de fuego</td>
                                         <td><input bind:value="{newData.homicide_by_firearm}"> </td>
                                        
                                     </tr><tr>
                                         <td>Armas de mano</td>
                                         <td><input bind:value="{newData.handgun}"> </td>
                                         
                                         
                                     </tr><tr>
                                         <td>Armas largas</td>
                                         <td><input bind:value="{newData.rifle}"> </td>
                                    </tr><tr>
                                        <td>Escopetas</td>
                                        <td><input bind:value="{newData.shotgun}"> </td>

                                    </tr><tr>
                                        <td>Tipo no indicado</td>
                                        <td><input bind:value="{newData.type_not_stated}"> </td>
                         ...
                         <Table >
                             ...
                             <tbody>
                                     ...
                                     <tr>
                                         ...
                                         <td><input bind:value="{databusqueda.homicide_by_firearm}"> </td>
                                        
                                     </tr><tr>
                                         <td>Armas de mano</td>
                                         <td><input bind:value="{databusqueda.handgun}"> </td>
                                         
                                         
                                     </tr><tr>
                                         <td>Rifles</td>
                                         <td><input bind:value="{databusqueda.rifle}"> </td>
                                    </tr><tr>
                                        <td>Escopetas</td>
                                        <td><input bind:value="{databusqueda.shotgun}"> </td>
                                    </tr><tr>
                                        <td>Tipo no indicado</td>
                                        <td><input bind:value="{databusqueda.type_not_stated}"> </td>
     ...
     {#if data.length != 0}
         ...
         <tbody>
             {#each data as data}
                 <tr>
                     <td><a href="#/homicides/{data.state}/{data.year}">{data.state}</a></td>
                     <td>{data.year}</td>
